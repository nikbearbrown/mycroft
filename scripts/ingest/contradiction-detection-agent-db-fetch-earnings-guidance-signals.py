...
NODE_NAME = 'DB: Fetch Earnings Guidance Signals'
...
def db_fetch_earnings_guidance_signals(payload: Any) -> dict[str, Any]:
    """Purpose: Prepare or load source data for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(db_fetch_earnings_guidance_signals(payload["data"]), payload["output"])

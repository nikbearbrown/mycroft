...
NODE_NAME = 'HTTP Request (Repo Metadata)'
...
def http_request_repo_metadata(payload: Any) -> dict[str, Any]:
    """Purpose: Prepare or load source data for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(http_request_repo_metadata(payload["data"]), payload["output"])

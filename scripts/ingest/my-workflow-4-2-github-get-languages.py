...
Recipe: recipes/my-workflow-4-2.md
"""
...
WORKFLOW_SLUG = 'my-workflow-4-2'
NODE_NAME = 'GitHub: Get Languages'
...
def github_get_languages(payload: Any) -> dict[str, Any]:
    """Purpose: Prepare or load source data for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(github_get_languages(payload["data"]), payload["output"])

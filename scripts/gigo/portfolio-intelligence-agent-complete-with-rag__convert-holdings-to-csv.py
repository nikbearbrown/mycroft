...
NODE_NAME = 'Convert Holdings to CSV'
NODE_TYPE = 'n8n-nodes-base.convertToFile'
CLASSIFICATION = 'gigo'
...
def convert_holdings_to_csv(payload: Any) -> dict[str, Any]:
    """Purpose: Clean, normalize, validate, or prepare storage payloads for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(convert_holdings_to_csv(payload["data"]), payload["output"])

"""Purpose: Validate and pass through collection B document chunks.
Input: Document records from data/verified/news-monitoring-agent/.
Output: Non-empty document chunks for collection news_articles_b.
...
def split_documents_b(items: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Purpose: Validate and pass through collection B document chunks.
...
if __name__ == "__main__":
    ...
    emit_json(split_documents_b(payload["data"]), payload["output"])

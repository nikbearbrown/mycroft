...
NODE_NAME = 'Insert or update rows in a table'
...
def insert_or_update_rows_in_a_table(payload: Any) -> dict[str, Any]:
    """Purpose: Clean, normalize, validate, or prepare storage payloads for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(insert_or_update_rows_in_a_table(payload["data"]), payload["output"])

...
NODE_NAME = 'Startup Investors SQL node'
...
def startup_investors_sql_node(payload: Any) -> dict[str, Any]:
    """Purpose: Clean, normalize, validate, or prepare storage payloads for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(startup_investors_sql_node(payload["data"]), payload["output"])

...
NODE_NAME = 'Extract from File'
NODE_TYPE = 'n8n-nodes-base.extractFromFile'
CLASSIFICATION = 'gigo'
...
def extract_from_file(payload: Any) -> dict[str, Any]:
    """Purpose: Clean, normalize, validate, or prepare storage payloads for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(extract_from_file(payload["data"]), payload["output"])

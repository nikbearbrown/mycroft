...
NODE_NAME = 'Groq: Analyse Contradictions'
...
def groq_analyse_contradictions(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(groq_analyse_contradictions(payload["data"]), payload["output"])

...
NODE_NAME = 'Read Portfolio History CSV'
...
def read_portfolio_history_csv(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(read_portfolio_history_csv(payload["data"]), payload["output"])

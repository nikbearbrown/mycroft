...
NODE_NAME = 'Read/Write Files from Disk1'
...
def read_write_files_from_disk1(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(read_write_files_from_disk1(payload["data"]), payload["output"])

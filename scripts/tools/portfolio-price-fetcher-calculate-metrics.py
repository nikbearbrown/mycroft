...
WORKFLOW_NAME = 'Portfolio Price Fetcher'
WORKFLOW_SLUG = 'portfolio-price-fetcher'
NODE_NAME = 'Calculate Metrics'
...
if __name__ == "__main__":
    ...
    emit(calculate_metrics(payload["data"]), payload["output"])

...
Recipe: recipes/my-workflow-4.md
"""
...
WORKFLOW_SLUG = 'my-workflow-4'
NODE_NAME = 'Message a model'
...
def message_a_model(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(message_a_model(payload["data"]), payload["output"])

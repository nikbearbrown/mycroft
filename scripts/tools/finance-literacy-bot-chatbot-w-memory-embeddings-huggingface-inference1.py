...
Recipe: recipes/finance-literacy-bot-chatbot-w-memory.md
"""
...
WORKFLOW_NAME = 'Finance Literacy Bot - Chatbot w/ Memory'
WORKFLOW_SLUG = 'finance-literacy-bot-chatbot-w-memory'
NODE_NAME = 'Embeddings HuggingFace Inference1'
NODE_TYPE = '@n8n/n8n-nodes-langchain.embeddingsHuggingFaceInference'
CLASSIFICATION = 'tool'
...
def embeddings_huggingface_inference1(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(embeddings_huggingface_inference1(payload["data"]), payload["output"])

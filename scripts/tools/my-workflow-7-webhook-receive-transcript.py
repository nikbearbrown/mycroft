...
NODE_NAME = 'Webhook: Receive Transcript'
...
def webhook_receive_transcript(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(webhook_receive_transcript(payload["data"]), payload["output"])

...
Recipe: recipes/investor-agent-part-2-2.md
"""
...
WORKFLOW_NAME = 'Investor agent - part 2'
WORKFLOW_SLUG = 'investor-agent-part-2-2'
NODE_NAME = 'RSS Read1'
...
def rss_read1(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(rss_read1(payload["data"]), payload["output"])

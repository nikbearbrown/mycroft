...
NODE_NAME = '🤖 Groq — Generate Investment Insights'
...
def groq_generate_investment_insights(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(groq_generate_investment_insights(payload["data"]), payload["output"])

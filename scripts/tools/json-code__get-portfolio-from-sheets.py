...
WORKFLOW_NAME = 'Json_code'
WORKFLOW_SLUG = 'json-code'
NODE_NAME = 'Get Portfolio from Sheets'
...
def get_portfolio_from_sheets(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(get_portfolio_from_sheets(payload["data"]), payload["output"])

...
Recipe: recipes/what-if-simulation-agent.md
"""
...
WORKFLOW_NAME = 'What-If Simulation Agent'
WORKFLOW_SLUG = 'what-if-simulation-agent'
NODE_NAME = '🎯 Webhook — Receive Simulation Request'
...
def webhook_receive_simulation_request(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(webhook_receive_simulation_request(payload["data"]), payload["output"])

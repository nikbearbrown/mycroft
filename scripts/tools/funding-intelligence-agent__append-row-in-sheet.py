...
Recipe: recipes/funding-intelligence-agent.md
"""
...
WORKFLOW_NAME = 'Funding Intelligence Agent'
WORKFLOW_SLUG = 'funding-intelligence-agent'
NODE_NAME = 'Append row in sheet'
...
def append_row_in_sheet(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(append_row_in_sheet(payload["data"]), payload["output"])

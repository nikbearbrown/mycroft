...
NODE_NAME = 'Recursive Character Text Splitter'
...
def recursive_character_text_splitter(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(recursive_character_text_splitter(payload["data"]), payload["output"])

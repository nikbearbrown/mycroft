...
Recipe: recipes/portfolio-intelligence-agent-complete-with-rag.md
"""
...
WORKFLOW_NAME = 'Portfolio Intelligence Agent - Complete with RAG'
WORKFLOW_SLUG = 'portfolio-intelligence-agent-complete-with-rag'
NODE_NAME = 'Calculate Portfolio Metrics'
...
def calculate_portfolio_metrics(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(calculate_portfolio_metrics(payload["data"]), payload["output"])

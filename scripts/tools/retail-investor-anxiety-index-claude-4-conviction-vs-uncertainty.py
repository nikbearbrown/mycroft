...
Recipe: recipes/retail-investor-anxiety-index.md
"""
...
WORKFLOW_NAME = 'Retail Investor Anxiety Index'
WORKFLOW_SLUG = 'retail-investor-anxiety-index'
NODE_NAME = 'Claude 4: Conviction vs Uncertainty'
...
def claude_4_conviction_vs_uncertainty(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(claude_4_conviction_vs_uncertainty(payload["data"]), payload["output"])

...
NODE_NAME = 'Search Knowledge Base Files'
...
def search_knowledge_base_files(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(search_knowledge_base_files(payload["data"]), payload["output"])

...
Recipe: recipes/my-workflow-7.md
"""
...
WORKFLOW_NAME = 'My workflow 7'
WORKFLOW_SLUG = 'my-workflow-7'
NODE_NAME = 'Groq: Parse Transcript Sections'
...
def groq_parse_transcript_sections(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(groq_parse_transcript_sections(payload["data"]), payload["output"])

...
Recipe: recipes/mycroftresearchagent-2-0.md
"""
...
WORKFLOW_NAME = 'MycroftResearchAgent_2.0'
WORKFLOW_SLUG = 'mycroftresearchagent-2-0'
NODE_NAME = 'Merge Competitive Analysis'
...
def merge_competitive_analysis(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(merge_competitive_analysis(payload["data"]), payload["output"])

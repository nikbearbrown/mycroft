...
Recipe: recipes/social-sentiment-agent-workflow.md
"""
...
WORKFLOW_SLUG = 'social-sentiment-agent-workflow'
NODE_NAME = 'Groq Topic Classification'
...
def groq_topic_classification(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(groq_topic_classification(payload["data"]), payload["output"])

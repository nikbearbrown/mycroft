...
NODE_NAME = '🧠 Aggregate & Score All Simulations'
...
def aggregate_score_all_simulations(payload: Any) -> dict[str, Any]:
    """Purpose: Produce a deterministic local tool result or live-call handoff specification for this converted workflow node.
...
if __name__ == "__main__":
    ...
    emit(aggregate_score_all_simulations(payload["data"]), payload["output"])

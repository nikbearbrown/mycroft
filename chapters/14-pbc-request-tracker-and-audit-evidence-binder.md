# 14. PBC Request Tracker and Audit-Evidence Binder

## Concrete Failure or Work Scenario

The audit request list has thirty items, five owners, and ten folders of support. The risk is not just missing a file; it is sharing the wrong file or claiming adequacy too early.
...
After this chapter, you will be able to assemble audit support while preserving privilege, adequacy, and reviewer gates.

**Assessment artifact:** PBC tracker and binder index.
...
Ingest the PBC list, assign owners and due dates, map support to request IDs, check reviewer sign-off, identify overdue or partial items, and build a binder index.
...
AI can organize and flag gaps. Humans judge adequacy, privilege, and auditor communication.
...
- Every request has owner/status/support path
- privilege concerns are flagged
...
AI cannot decide what is adequate audit evidence or what may be shared.
...
Revenue and billing exceptions raise an even stricter accounting-policy boundary.
...
- `pantry/14-pbc-request-tracker-and-audit-evidence-binder_notes.md`

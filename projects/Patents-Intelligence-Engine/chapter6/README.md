...
| `theses/earnings-surprise-STM-Q2-2026.md` | Ch.6 | Reported actuals vs. consensus estimates and prior guidance for Q2 2026, with a deliberately blank "current explanation" column. Surfaced a real discrepancy: two sources report STM's Q3 guidance differently, which matters because the pre-committed exit signal in `CANNOT-KNOW.md` depends on the guided range being correct. |

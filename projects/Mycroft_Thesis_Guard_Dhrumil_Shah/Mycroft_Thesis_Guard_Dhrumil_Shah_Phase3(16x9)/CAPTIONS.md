# Captions — Mycroft Phase 3 (16:9)

- **File:** `subtitles/mycroft_phase3_4k_16x9.srt` (copy in `outputs/`), 93 cues.
- **Burned in:** yes, centred at y 1900 on a black plate at 69 % opacity, white bold 66 px.

# Consolidated video-generation prompt — Mycroft Phase 3 (9:16)
...
Create a professional 9:16 vertical technical demonstration video, 2160 × 3840, 30 FPS, H.264 + AAC, 2–3 minutes, covering **only** the Phase 3 section of `Mycroft_Dhrumil2.ipynb` — "Mycroft_Dhrumil_Shah_Phase_3 (Building more AI agents)", cells A1–A13. Earlier phases appear only where Phase 3 consumes their outputs: the Phase 1 cleaned price panel, `latest_company_predictions.csv`, `test_predictions.csv.gz`, and the Phase 2 regime labels.
...
Dark AI / FinTech interface: background gradient #080E1C → #101A30 with a faint grid; teal #2DD4BF primary, blue #388BFD, violet #A78BFA, amber #FBBF24 for callouts and flags, red #F87171 for risk, green #4ADE80 for passing checks. DejaVu Sans for text, DejaVu Sans Mono for code. One concept per screen, vertically stacked workflows, short labels, no wide tables.

Safe area: content between x 150–1930 and y 820–2660; frame furniture at y 405–640; captions centred at y 2830; nothing below y 3100.

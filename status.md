...
- **Applied projects:** AI Vendor Intelligence exercises, upstream case-study projects, and the DRAFT Mycroft Finance Investigator, which now runs locally from synthetic raw data through validation, deterministic EBITDA analysis, conditional tool selection, separate machine/human outputs, a run-bound human review gate, isolated planted-discrepancy evaluation, evidence-linked scenario sensitivities, and immutable audit-bundle handoff.

...
- **Applied projects:** AI Vendor Intelligence exercises, upstream case-study projects, and the DRAFT Mycroft Finance Investigator, which now runs locally from synthetic raw data through validation, deterministic EBITDA analysis, conditional tool selection, separate machine/human outputs, a run-bound human review gate, isolated planted-discrepancy evaluation, evidence-linked scenario sensitivities, immutable audit-bundle handoff, hash-verified multi-month trend investigation, constrained specialist-agent routing, and review-driven exact replay.
...
## Recently done (2026-09-10)
- Added a run-bound review follow-up loop that replays specialist outputs and
  separates verified evidence integrity, unsupported causal claims, and open
  evidence requests. The sample remains a synthetic exercise and cannot clear
  materiality, causal, adequacy, or release gates.

## Previously done (2026-09-04)
- Added an evidence-gap supervisor that verifies the trend lineage, prioritizes
  recurring adverse categories, and delegates work to fixed-scope revenue,
  cost, and workforce specialists. The machine records every handoff while
  causal explanation and approval remain human-owned.

## Previously done (2026-08-28)
- Added a three-period Finance Investigator history and deterministic trend
  comparison. Each period is independently validated and bound to its run and
  source hashes; the report identifies historical movement and recurring
  material categories while leaving causation, forecast, recommendation, and
  distribution as open human decisions.

## Previously done (2026-08-21)
- Added a self-contained Finance Investigator audit bundle containing the exact
  data, specifications, implementation, tests, logs, and human views for one
  run. Cross-artifact validation and independent checksum verification preserve
  the evidence chain while release remains blocked on named human review.

## Previously done (2026-08-13)

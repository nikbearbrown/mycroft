...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/Investor_Intelligence/Investor agent - part 2.json`
- Imported from pantry path: `n8n_Workflows/Investor_Intelligence/Investor agent - part 2.json`
- Node count: 9
...
Insert or update rows in a table, Execute a SQL query, Insert or update rows in a table1, Execute a SQL query1

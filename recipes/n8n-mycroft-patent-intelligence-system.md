# Recipe: Mycroft - Patent Intelligence System
...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/Patent_Intelligence_Agent/Mycroft - Patent Intelligence System.json`
- Imported from pantry path: `n8n_Workflows/Patent_Intelligence_Agent/Mycroft - Patent Intelligence System.json`
- Node count: 14
...
Send Report Email, Error Notification
...
| 5 | Setup Environment and Output Directories | executeCommand |
| 6 | Extract Patents | executeCommand |
| 7 | Check Extraction Success | if |
| 8 | Process Patents | executeCommand |
| 9 | Read Processed Data | readBinaryFile |
| 10 | Read Metrics | readBinaryFile |
| 11 | Send Report Email | emailSend |
| 12 | Error Notification | emailSend |
| 13 | Cleanup Repository | executeCommand |
| 14 | Cleanup Repository Error | executeCommand |

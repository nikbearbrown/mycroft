...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/Forecasting_Agent/Forecasting_Agent.json`
- Imported from pantry path: `n8n_Workflows/Forecasting_Agent/Forecasting_Agent.json`
- Node count: 14
...
Alpha Vantage Market Data, FinBert, Execute a SQL query, Insert rows in a table, Send email
...
| 11 | Insert rows in a table | postgres |
| 12 | Send email | emailSend |
| 13 | Historical data | code |
| 14 | Code | code |

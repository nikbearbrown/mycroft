...
2. Step name: RSS Read. Labor: AI with Human gate.
   Script called: `scripts/tools/investor-agent-part-2-2__rss-read.py`
   Input: approved upstream output or sample fixture.
   Output: local handoff JSON fields: action, approved_for_live_action:false, input_refs, output_refs, flags, live_call_performed.
   Where output goes: logs/.
3. Step name: Insert or update rows in a table. Labor: AI with Human gate.
   Script called: `scripts/gigo/investor-agent-part-2-2__insert-or-update-rows-in-a-table.py`
   Input: approved upstream output or sample fixture.
...
4. Step name: Execute a SQL query. Labor: AI with Human gate.
   Script called: `scripts/ingest/investor-agent-part-2-2__execute-a-sql-query2.py`
   Input: approved upstream output or sample fixture.
   Output: verified JSON fields: record_count, records, rejects, duplicates, missing_fields, validation_flags.
   Where output goes: data/verified/investor-agent-part-2-2/.
5. Step name: Insert or update rows in a table1. Labor: AI with Human gate.
   Script called: `scripts/gigo/investor-agent-part-2-2__insert-or-update-rows-in-a-table1.py`
   Input: approved upstream output or sample fixture.
   Output: verified JSON fields: record_count, records, rejects, duplicates, missing_fields, validation_flags.
   Where output goes: data/verified/investor-agent-part-2-2/.
6. Step name: Execute a SQL query1. Labor: AI with Human gate.
   Script called: `scripts/gigo/investor-agent-part-2-2__execute-a-sql-query1.py`
   Input: approved upstream output or sample fixture.
   Output: verified JSON fields: record_count, records, rejects, duplicates, missing_fields, validation_flags.
   Where output goes: data/verified/investor-agent-part-2-2/.
7. Step name: Normalize Data. Labor: AI with Human gate.
   Script called: `scripts/gigo/investor-agent-part-2-2__normalize-data.py`
   Input: approved upstream output or sample fixture.
   Output: verified JSON fields: record_count, records, rejects, duplicates, missing_fields, validation_flags.
   Where output goes: data/verified/investor-agent-part-2-2/.
8. Step name: RSS Read1. Labor: AI with Human gate.
   Script called: `scripts/tools/investor-agent-part-2-2__rss-read1.py`
   Input: approved upstream output or sample fixture.
   Output: local handoff JSON fields: action, approved_for_live_action:false, input_refs, output_refs, flags, live_call_performed.
   Where output goes: logs/.
...
10. Step name: Produce human report. Labor: AI with Human review.
   Script called: `[TODO: DEV] Create or map script path: scripts/tools/investor-agent-part-2-2__produce-human-report.py`
...
|---|---|---|
| RSS Read | `snickerdoodle run investor-agent-part-2-2 --step rss-read` | `--no-write` |
| Insert or update rows in a table | `snickerdoodle run investor-agent-part-2-2 --step insert-or-update-rows-in-a-table` |  |
| Execute a SQL query | `snickerdoodle run investor-agent-part-2-2 --step execute-a-sql-query` |  |
| Insert or update rows in a table1 | `snickerdoodle run investor-agent-part-2-2 --step insert-or-update-rows-in-a-table1` |  |
| Execute a SQL query1 | `snickerdoodle run investor-agent-part-2-2 --step execute-a-sql-query1` |  |
| Normalize Data | `snickerdoodle run investor-agent-part-2-2 --step normalize-data` |  |
| RSS Read1 | `snickerdoodle run investor-agent-part-2-2 --step rss-read1` | `--no-write` |
| Execute a SQL query2 | `snickerdoodle run investor-agent-part-2-2 --step execute-a-sql-query2` | `--sample` |
| Produce human report | `snickerdoodle run investor-agent-part-2-2 --step produce-human-report` | `--no-write` |

### Gate Commands

| Gate | CLI Command |
|---|---|
| Gate 1 - source/input readiness | `snickerdoodle gate investor-agent-part-2-2 --gate 1 --decision approve --note "..."` |
| Gate 2 - sample run | `snickerdoodle gate investor-agent-part-2-2 --gate 2 --decision approve --note "..."` |
| Gate 3 - report contract | `snickerdoodle gate investor-agent-part-2-2 --gate 3 --decision approve --note "..."` |

### Script Locations

| Step | Script Path | Layer |
|---|---|---|
| RSS Read | `scripts/tools/investor-agent-part-2-2__rss-read.py` | tool |
| Insert or update rows in a table | `scripts/gigo/investor-agent-part-2-2__insert-or-update-rows-in-a-table.py` | gigo |
| Execute a SQL query | `scripts/ingest/investor-agent-part-2-2__execute-a-sql-query2.py` | gigo |
| Insert or update rows in a table1 | `scripts/gigo/investor-agent-part-2-2__insert-or-update-rows-in-a-table1.py` | gigo |
| Execute a SQL query1 | `scripts/gigo/investor-agent-part-2-2__execute-a-sql-query1.py` | gigo |
| Normalize Data | `scripts/gigo/investor-agent-part-2-2__normalize-data.py` | gigo |
| RSS Read1 | `scripts/tools/investor-agent-part-2-2__rss-read1.py` | tool |
| Execute a SQL query2 | `scripts/ingest/investor-agent-part-2-2__execute-a-sql-query2.py` | ingest |
| Produce human report | `[TODO: DEV] Create or map script path: scripts/tools/investor-agent-part-2-2__produce-human-report.py` | tool |

# Recipe: Portfolio Price Fetcher
...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/Portfolio_Visualization_Agent/Portfolio Price Fetcher.json`
- Imported from pantry path: `n8n_Workflows/Portfolio_Visualization_Agent/Portfolio Price Fetcher.json`
- Node count: 5
...
| 2 | Define Portfolio | code |
| 3 | Fetch Stock Prices | httpRequest |
| 4 | Calculate Metrics | code |
| 5 | Aggregate Summary | code |

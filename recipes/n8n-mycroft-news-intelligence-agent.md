...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/AI_NEWS_SENTIMENT/Mycroft News Intelligence Agent.json`
- Imported from pantry path: `n8n_Workflows/AI_NEWS_SENTIMENT/Mycroft News Intelligence Agent.json`
- Node count: 16
...
NewsApiKey, HTTP Request, HTTP Request1, Insert rows in a table, Send email
...
| 6 | When clicking ‘Execute workflow’ | manualTrigger |
| 7 | HTTP Request | httpRequest |
| 8 | XML | xml |
| 9 | ProcessNewData | code |
| 10 | Edit Fields | set |
| 11 | HTTP Request1 | httpRequest |
| 12 | RiskCalculator | code |
| 13 | Insert rows in a table | postgres |
| 14 | Alert Generator Code Node | code |
| 15 | Send email | emailSend |
| 16 | DailyGeneratorCode | code |

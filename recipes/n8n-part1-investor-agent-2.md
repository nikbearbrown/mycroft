...
- Source: `data/mycroft-main/n8n-workflows/originals/n8n_Workflows/Investor_Intelligence/Sprint2_Part1 -Investor_ Agent.json`
- Imported from pantry path: `n8n_Workflows/Investor_Intelligence/Sprint2_Part1 -Investor_ Agent.json`
- Node count: 10
...
DB - Get Recent Deals, Send Response, Get top investor, Investor Profile SQL node, Startup Investors SQL node, Execute a SQL query, Webhook
...
| Order | Node | Type |
| --- | --- | --- |
| 1 | Parse User Question | code |
| 2 | DB - Get Recent Deals | postgres |
| 3 | Format Chatbot Response | code |
| 4 | Send Response | respondToWebhook |
| 5 | Get top investor | postgres |
| 6 | Route by Query Type  | switch |
| 7 | Investor Profile SQL node | postgres |
| 8 | Startup Investors SQL node | postgres |
| 9 | Execute a SQL query | postgres |
| 10 | Webhook | webhook |

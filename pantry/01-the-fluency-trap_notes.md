# Research Notes: Chapter 01 - The Fluency Trap

**Source:** TIKTOC.md chapter entry
**Notes file:** 01-the-fluency-trap_notes.md
**Corresponding chapter:** chapters/01-the-fluency-trap.md (not yet written)
...
Detect the gap between fluent finance output and trustworthy finance work. The chapter opens with a clean AI-generated variance commentary, close summary, or board-packet note that sounds plausible but hides unsupported explanations, stale sources, missing period labels, and no approval gate.
...
### Finance artifacts mix numbers, explanations, and approvals
...
### Generated text is an artifact, not a source
...
### Review begins by separating claim, number, assumption, and owner
...
### Case 1: AI-written variance commentary with no driver data
...
### Case 2: Board-packet note with stale chart period

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Close summary that says 'ready' while support is missing
...
- The Fluency Trap unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Introduction: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 2: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Presentation quality does not establish source adequacy, data freshness, or approval status.
...
- How much drafting AI should do before human review depends on control maturity and reviewer behavior.
...
- Give readers a polished finance paragraph and make them classify every number, explanation, and approval implication.

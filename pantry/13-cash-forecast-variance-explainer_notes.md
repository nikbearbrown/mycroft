# Research Notes: Chapter 13 - Cash Forecast Variance Explainer

**Source:** TIKTOC.md chapter entry
**Notes file:** 13-cash-forecast-variance-explainer_notes.md
**Corresponding chapter:** chapters/13-cash-forecast-variance-explainer.md (not yet written)
...
Compare forecast cash to realized cash without inventing causes: forecast version control, realized cash, category variance, bridge structure, known drivers, unexplained variances, and reforecast gates.
...
### Case 1: Collections below forecast with no driver note
...
### Case 2: Payroll outflow timing explains variance

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Forecast and actuals cover different periods and stop the run
...
- Cash Forecast Variance Explainer unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 12: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 14: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Forecast-to-actual comparison is useful only when periods and versions match.
...
- Forecast revisions require business judgment about persistence versus timing.
...
- Create a cash bridge with forecast, actual, variance, known driver, and needs-explanation columns.

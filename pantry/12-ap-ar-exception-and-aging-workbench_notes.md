# Research Notes: Chapter 12 - AP/AR Exception and Aging Workbench

**Source:** TIKTOC.md chapter entry
**Notes file:** 12-ap-ar-exception-and-aging-workbench_notes.md
**Corresponding chapter:** chapters/12-ap-ar-exception-and-aging-workbench.md (not yet written)
...
Turn AP and AR aging into exception queues without external action: aging buckets, duplicate invoice flags, missing support, dispute status, owner queues, and communication gates.
...
### Duplicate invoice candidate versus confirmed duplicate
...
### No customer/vendor communication without approval
...
### Case 1: Same vendor, amount, and invoice date flags duplicate risk
...
### Case 2: AR item over 90 days lacks dispute owner

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Unknown counterparty blocks action queue
...
- AP/AR Exception and Aging Workbench unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 11: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 13: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- AP/AR work is high-volume and exception-oriented.
...
- Duplicate-detection tolerances and near-match rules need local approval.
...
- Build AP/AR queues by aging tier, owner, duplicate risk, and missing support.

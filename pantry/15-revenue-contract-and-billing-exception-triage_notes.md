# Research Notes: Chapter 15 - Revenue Contract and Billing Exception Triage

**Source:** TIKTOC.md chapter entry
**Notes file:** 15-revenue-contract-and-billing-exception-triage_notes.md
**Corresponding chapter:** chapters/15-revenue-contract-and-billing-exception-triage.md (not yet written)
...
Separate factual billing mismatches from accounting-policy questions: contract source-chain completeness, amendment order, billing setup comparison, pricing mismatches, milestone gaps, policy flags, and revenue-recognition stop conditions.

---

## A. Conceptual foundations

### Contract source chain
...
### Revenue recognition is human-only
...
### Case 1: Missing amendment stops review
...
### Case 2: Price list mismatch is operational

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Variable consideration is routed to accounting review
...
- Revenue Contract and Billing Exception Triage unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 14: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 16: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Contracts and billing records can be compared mechanically for factual mismatches.
...
- Revenue recognition conclusions depend on policy and professional judgment.
...
- Classify contract/billing exceptions into factual mismatch, missing documentation, and accounting review.

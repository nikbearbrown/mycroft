# Research Notes: Chapter 10 - Budget-Request Normalizer and Challenge Pack

**Source:** TIKTOC.md chapter entry
**Notes file:** 10-budget-request-normalizer-and-challenge-pack_notes.md
**Corresponding chapter:** chapters/10-budget-request-normalizer-and-challenge-pack.md (not yet written)
...
Normalize planning submissions and prepare challenge questions: template validation, account/category normalization, headcount/rate checks, prior-year comparison, policy flags, and business-partner sign-off.
...
### Case 1: Department submits old template
...
### Case 2: Unsupported headcount request

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Rate assumption exceeds approved reference table
...
- Budget-Request Normalizer and Challenge Pack unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 9: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 11: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Budget analysts review proposals for completeness, accuracy, and compliance with rules.
...
- Challenge aggressiveness depends on organizational planning culture.
...
- Normalize three budget requests and produce a challenge-question list.

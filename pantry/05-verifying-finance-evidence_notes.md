# Research Notes: Chapter 05 - Verifying Finance Evidence

**Source:** TIKTOC.md chapter entry
**Notes file:** 05-verifying-finance-evidence_notes.md
**Corresponding chapter:** chapters/05-verifying-finance-evidence.md (not yet written)
...
Interrogate completeness, freshness, control totals, mapping, thresholds, and warranted verbs. A parsed spreadsheet can still be wrong, and a sourced number can still be irrelevant.
...
### Contradictory evidence is still evidence
...
### Case 1: Mapped actuals with unmapped material account
...
### Case 2: Subledger tie-out with stale extract

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Variance explanation that should say 'may suggest' instead of 'caused'
...
- Verifying Finance Evidence unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 4: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 6: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Audit evidence standards emphasize sufficiency and appropriateness; finance analysis needs similar discipline.
...
- How much automated anomaly detection is enough before human review starts.
...
- Write can say, can suggest, cannot claim, needs review for a small evidence packet.

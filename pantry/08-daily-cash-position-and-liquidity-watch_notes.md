# Research Notes: Chapter 08 - Daily Cash Position and Liquidity Watch

**Source:** TIKTOC.md chapter entry
**Notes file:** 08-daily-cash-position-and-liquidity-watch_notes.md
**Corresponding chapter:** chapters/08-daily-cash-position-and-liquidity-watch.md (not yet written)
...
Produce a read-only cash view with hard treasury action boundaries: bank feed freshness, normalized balances, reconciliation where possible, availability buckets, thresholds, and escalation.

---

## A. Conceptual foundations

### Read-only treasury automation
...
### Cash availability and restriction
...
### Case 1: Missing bank feed stops the run
...
### Case 2: Unknown account excluded from consolidated cash

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Liquidity threshold breach escalates but does not trigger a transfer
...
- Daily Cash Position and Liquidity Watch unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 7: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 9: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Cash visibility is operationally useful but banking actions require human authority.
...
- How real-time cash visibility should be depends on bank feeds and treasury controls.
...
- Build a daily cash table with as-of timestamps, account, entity, currency, availability, and threshold flag.

# Research Notes: Chapter 02 - The Reallocation Principle

**Source:** TIKTOC.md chapter entry
**Notes file:** 02-the-reallocation-principle_notes.md
**Corresponding chapter:** chapters/02-the-reallocation-principle.md (not yet written)
...
Reframe finance automation as scarce judgment allocation. The goal is not more dashboards, more commentary, or faster spreadsheet churn. The goal is to reallocate human effort toward materiality, explanation, review, risk, and release.

---

## A. Conceptual foundations

### Preparation work versus judgment work
...
### AI reduces the cost of extraction and comparison
...
### Human review time should move toward materiality and interpretation
...
### Automation that weakens review is a failure
...
### Case 1: FP&A analyst stops hand-building variance tables and spends more time on owner explanations
...
### Case 2: Staff accountant uses matching automation but still owns recon sign-off

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Treasury analyst gets faster cash visibility without automated transfers
...
- The Reallocation Principle unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 1: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 3: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Many finance tasks include repeated data gathering, checking, and report assembly that can be structured.
...
- The exact labor split varies by regulation, company policy, systems, and reviewer capacity.
...
- Map one week of finance work into preparation, evidence, transformation, judgment, approval, and release.

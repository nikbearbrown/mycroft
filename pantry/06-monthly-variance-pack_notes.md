# Research Notes: Chapter 06 - Monthly Variance Pack

**Source:** TIKTOC.md chapter entry
**Notes file:** 06-monthly-variance-pack_notes.md
**Corresponding chapter:** chapters/06-monthly-variance-pack.md (not yet written)
...
Build a variance pack that separates verified deltas from human explanations: actuals, budget, forecast, mapping tables, thresholds, control totals, material variance flags, owner commentary, and open items.
...
### Commentary stubs, not causal conclusions
...
### Case 1: Department spend above budget due to payroll timing
...
### Case 2: Revenue below forecast without owner explanation

The case should be written as a realistic finance work scenario. Show the source files, the check performed, the exception or gap surfaced, and the human gate that prevents the recipe from overstepping. The key teaching point is that the recipe makes review easier; it does not perform the accountable judgment.

**Source(s):** TIKTOC.md; reports/generated/entry-mid-finance-recipes-research.md; reports/generated/mycroft-finance-recipe-opportunities-attached-research.md

### Case 3: Stale budget version blocks the run
...
- Monthly Variance Pack unlocks later recipes by giving the reader a concrete artifact pattern they can reuse.
...
- Chapter 5: supplies the prerequisite frame or artifact that this chapter builds on.
- Chapter 7: uses this chapter's evidence boundary, recipe pattern, or output surface.
...
- Variance analysis is a recurring finance workflow that compares current and historical financial data.
...
- The materiality threshold and acceptable driver evidence are organization-specific.
...
- Build a variance table with source, delta, threshold status, known driver, and owner-needed fields.

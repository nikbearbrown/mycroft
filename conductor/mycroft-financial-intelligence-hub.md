# Mycroft - Financial Intelligence Hub — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Mycroft - Financial Intelligence Hub`.

# Contradiction_detection_agent — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Contradiction_detection_agent`.

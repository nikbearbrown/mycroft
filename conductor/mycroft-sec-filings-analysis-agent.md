# Mycroft - SEC Filings Analysis Agent — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Mycroft - SEC Filings Analysis Agent`.

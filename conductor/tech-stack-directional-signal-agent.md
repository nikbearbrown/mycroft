# Tech_Stack_Directional_Signal_Agent — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Tech_Stack_Directional_Signal_Agent`.

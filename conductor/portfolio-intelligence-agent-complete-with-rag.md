# Portfolio Intelligence Agent - Complete with RAG — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Portfolio Intelligence Agent - Complete with RAG`.

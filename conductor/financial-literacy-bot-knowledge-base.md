# Financial Literacy Bot - Knowledge Base — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Financial Literacy Bot - Knowledge Base`.

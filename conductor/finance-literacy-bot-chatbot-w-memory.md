# Finance Literacy Bot - Chatbot w/ Memory — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Finance Literacy Bot - Chatbot w/ Memory`.

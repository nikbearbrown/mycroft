# Mycroft - SEC_Filings_Analysis_Enhanced — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Mycroft - SEC_Filings_Analysis_Enhanced`.

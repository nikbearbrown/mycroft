# Finance Literacy Bot - RAG & ChatBot — Conductor Flow
...
Triggered by the original n8n trigger surface or a manual Mycroft request for `Finance Literacy Bot - RAG & ChatBot`.
